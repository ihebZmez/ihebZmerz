...
I'm an indie Full-Stack developer that can work on Front-End or Back-End, scripting automater and CI/CD implementor building my version of the digital world one step at a time. All coding projects are built from the ground up, from planning and designing all the way to solving real-life problems with code. All my freelance project is built the same way, from ideation and planning. I publish that content on my parcour on "(https://iheb-zm-portfolio.netlify.app/)".
<!--
   <p align="left">
...
<img align="left" alt="Gradle" width="30px" style="padding-right:10px;" src="https://cdn.jsdelivr.net/npm/simple-icons@v3/icons/flutter.svg" />
<br />
